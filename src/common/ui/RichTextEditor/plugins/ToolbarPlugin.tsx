...
function positionEditorElement(editor: any, rect: ay) {
  if (rect === null) {
      ...
      {supportedBlockTypes.has(blockType) && (
        <>
          ...
          >
            ...
            <span className="text">{blockTypeToBlockName[blockType] as any}</span>
